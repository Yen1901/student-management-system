! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        var o = this,
            i = e("<form></form>");
        i.append("<label>Sửa lịch</label>"), i.append("<div class='input-group'><input class='form-control mr-2' type=text value='" + t.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-primary waves-effect waves-light'><i class='fa fa-check'></i> Lưu</button></span></div>"), o.$modal.modal({
            backdrop: "static"
