                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Lớp học phần</a></li>
                        </ol>
                    </div>
                </div>
													...
													<div class="modal-body">
														<form action="#" method="post">
															<div class="row">
																...
																<div class="col-lg-6 col-md-6 col-sm-12">
																	<div class="form-group">
																		<label class="form-label">Thời gian BĐ</label>
																		<input type="text" class="form-control">
																	</div>
																</div>
																<div class="col-lg-6 col-md-6 col-sm-12">
																	<div class="form-group">
																		<label class="form-label">Thời gian KT</label>
																		<input type="text" class="form-control">
																	</div>
																</div>
																<div class="col-lg-6 col-md-6 col-sm-12">
																	<div class="form-group">
																		<label class="form-label">SLSVTĐ</label>
																		<input type="text" class="form-control">
																	</div>
																</div>
																<div class="col-lg-6 col-md-6 col-sm-12">
										...
										<div class="table-responsive table-responsive-custom">
											<table id="example3" class="display custom-table" style="min-width: 845px">
												...
												<tbody>
													<tr>
														<td></td>
														<td><a href="javascript:void(0);"><strong>LHP001</strong></a></td>
														<td>Lớp IT001</td>
														<td>02-02-2024</td>
														<td>26-06-2004</td>
														<td>60</td>
														<td><a href="javascript:void(0);"><strong>P001</strong></a></td>
														<td><a href="javascript:void(0);"><strong>MHP001</strong></a></td>
														<td>
