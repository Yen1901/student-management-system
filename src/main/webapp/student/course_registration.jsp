      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Đăng ký học phần</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        <thead class="table-dark">
                            <tr>
								...
								<th class="text-center">Số lượng sinh viên tối đa</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>LP004</td>
                                <td>Lớp IT004</td>
                                <td>Lớp học LTJava</td>
								<td>60</td>
                                <td><a href="#">Đăng ký <i class="bi bi-pencil-square"></i></a></td>
                            </tr>
							<tr>
                                <td>MH005</td>
