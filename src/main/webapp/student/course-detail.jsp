   ...
   <main class="main">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
			...
			<li class="current">Chi tiết học phần</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section id="courses-course-details" class="courses-course-details section">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
		<img src="img/course-4.jpg" class="img-fluid col-lg-4" alt="" style="height: 100%;margin-top: 85px;">
          <div class="col-lg-8">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Trình độ đào tạo</h5>
              <p></p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Học phần học trước</h5>
              <p></p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Học phần song hành</h5>
              <p></p>
            </div>
			<div class="course-info d-flex justify-content-between align-items-center">
              <h5>Học phần tiên quyết</h5>
              <p></p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Học phần tương đương</h5>
              <p></p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Số lượng sing viên tối đa</h5>
              <p></p>
            </div>
        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Tài liệu tham khảo</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-2">Nhóm biên soạn</a>
              </li>
              </li>
            </ul>
          </div>
              ...
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  <div class="details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">Tài liệu chính</p>
                    <p>
					[1] An Văn Minh, Trần Hùng Cường, Giáo trình cấu trúc dữ liệu và giải thuật, 2013 <br/>
					</p>
					<p class="fst-italic">Tài liệu tham khảo</p>
					<p>
					[1] Wirth, Niklaus, Algorithms and Data Structures, 2004 <br/>
					[2] Đỗ Xuân Lôi, Cấu trúc dữ liệu và giải thuật, 2005 <br/>
					[3] Sahni,Sartaj, Datastructures, Algorithms and Applications in C++, 2nd edition, 2005 <br/>
					</p>
                  </div>
                </div>
              </div>
